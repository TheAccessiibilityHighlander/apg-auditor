...
export default {
  ...
  signals: [
    ...
    },
    {
      ...
      weight: 9,
      required: false, // aria-describedby is on the trigger; fingerprint target is the tooltip popup
    ...
    },
    {
      ...
      weight: 6,
      required: false, // tooltip popup itself is not in the tab order (trigger is)
